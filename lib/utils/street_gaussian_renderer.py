...
class StreetGaussianRenderer():
    ...
    def render_object(
        ...
        result = self.render_kernel_obj(viewpoint_camera, pc, convert_SHs_python, compute_cov3D_python, scaling_modifier, override_color, white_background=True)
    ...
    def render(
        ...
        # ipdb.set_trace()
        # result = self.render_kernel(viewpoint_camera, pc, convert_SHs_python, compute_cov3D_python, scaling_modifier, override_color)
        result = self.render_kernel_all(viewpoint_camera, pc, convert_SHs_python, compute_cov3D_python, scaling_modifier, override_color)
        # print(viewpoint_camera.K.cpu())
